...
public class S0140 {
    ...
    public List<List<String>> backtrack(String s, int len, Set<String> wordSet, int cur, Map<Integer, List<List<String>>> map){
        if(!map.containsKey(cur)) {
            ...
            for (int i =cur+1;i<=len;i++){
                ...
                if(wordSet.contains(word)){
                    List<List<String>> nextWordBreaks = backtrack(s, len, wordSet, i, map);
